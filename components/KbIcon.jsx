// Keboola UI kit — shared icon set (Lucide). Inline SVGs to avoid runtime deps.
// All icons render at 1em with stroke="currentColor" and stroke-width="1.5".

const KbIcon = ({ name, size = 16, className = "", style = {} }) => {
...
const ICONS = {
  ...
  "sparkles": <><path d="M9.94 5.32 9 2 8.06 5.32a2 2 0 0 1-1.74 1.74L3 8l3.32.94a2 2 0 0 1 1.74 1.74L9 14l.94-3.32a2 2 0 0 1 1.74-1.74L15 8l-3.32-.94a2 2 0 0 1-1.74-1.74Z"/><path d="M19 11v4"/><path d="M21 13h-4"/><path d="M16 18h2"/><path d="M17 17v2"/></>,
  ...
  "paperclip": <path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l8.57-8.57A4 4 0 1 1 17.93 8.83l-8.57 8.57a2 2 0 1 1-2.83-2.83l8.49-8.48"/>,
  // misc
  ...
  "table": <><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" x2="21" y1="9" y2="9"/><line x1="3" x2="21" y1="15" y2="15"/><line x1="9" x2="9" y1="3" y2="21"/><line x1="15" x2="15" y1="3" y2="21"/></>,
  ...
  "edit": <><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.375 2.625a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4Z"/></>,
  ...
  "file-code": <><path d="M10 12.5 8 15l2 2.5"/><path d="m14 12.5 2 2.5-2 2.5"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M15 22H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8l6 6v12a2 2 0 0 1-2 2z"/></>,
  ...
  "save": <><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/></>,
